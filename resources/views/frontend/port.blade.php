...
<div id="all">
    ...
    <!--loader-->
    <div id="loader">
        <span class="color">Diyorbek</span>Fazliddinov
    </div>
    <!--loader-end-->
    <!--link-screen-->
    <div id="breaker">
    ...
    <div id="header">
        ...
        <div class="header-content">
            <div class="header-content-box">
                <div class="firstline"><span class="color">Diyorbek </span>Fazliddinov</div>
                <div class="secondline">
                    I'm a
                    <span class="txt-rotate color" data-period="1200"data-rotate='[  "Backand","Frontend","Developer" ]'></span>
